...
class TestCoverArtArchive(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_updating_cover_art(self):
        ...
        new_image1_json = ORIG_IMAGE1_JSON | {'comment': ''}
    ...
    async def test_deleting_cover_art_type(self):
        ...
        new_image1_json = ORIG_IMAGE1_JSON | {'front': False, 'types': []}
    ...
    async def test_event_triggers(self):
        ...
        await self.pg_conn.execute(dedent('''
            ...
            INSERT INTO event_art_archive.event_art (id, event, mime_type, edit, ordering, comment)
                VALUES (1, 1, 'image/jpeg', 3, 1, 'hello');
        '''))
        ...
        self.assertEqual(self.session.last_requests, [
            event_index_json_put(EVENT1_MBID, [new_image1_json]),
